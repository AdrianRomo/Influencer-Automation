Here’s a revised `AGENTS.md` that keeps your current repo context but adds the stronger execution rules and the product direction needed to push Codex toward a **full video-generation pipeline**, not just scripts + TTS.
